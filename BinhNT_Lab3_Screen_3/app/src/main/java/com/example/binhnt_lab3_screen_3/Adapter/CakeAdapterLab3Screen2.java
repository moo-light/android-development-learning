package com.example.binhnt_lab3_screen_3.Adapter;
...
import com.example.binhnt_lab3_screen_3.R;
import com.example.binhnt_lab3_screen_3.dtos.Cake;

import java.util.ArrayList;

public class CakeAdapterLab3Screen2 extends BaseAdapter {
    private Context context;
    private int layout;
    private ArrayList<Cake> cakeList;

    public CakeAdapterLab3Screen2(Context context, int layout, ArrayList<Cake> cakeList) {
