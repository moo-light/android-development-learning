...
import com.example.binhnt_lab3_screen_3.Adapter.CakeAdapterLab3Screen2;
...
public class MainActivityLab3Screen3 extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AnhXa();
        adapter = new CakeAdapterLab3Screen2(this, R.layout.cake_layout_l3_screen3, cakeList);
    ...
    private void AnhXa() {
        lvCake = findViewById(R.id.lvCake);
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            requestPermissions(
                    new String[]{
                            Manifest.permission.WRITE_EXTERNAL_STORAGE},REQUEST_CODE_FOR_SOURCE);
        }
